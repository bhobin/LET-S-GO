 ...
 */
public class CustomDialogBestDown extends Dialog {
    ...
    public CustomDialogBestDown(Context context, AQuery aq, String URL, String idx) {
        super(context);
        this.aq = aq;
        this.URL = URL;
        this.idx = idx;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_best_down);

        img = (ImageView) findViewById(R.id.image_dialog_best_down);
        okBtn = (Button) findViewById(R.id.button_ok_dialog_best_down);
        cancelBtn = (Button) findViewById(R.id.button_cancel_dialog_best_down);
